...
\articletype{CUG2017 Conference Proceeding}
...
\title{Application-Level Regression Testing Framework using Jenkins\protect\thanks{\textbf{Notice of copyright}: This manuscript has been authored by UT-Battelle, LLC under Contract No. DE-AC05-00OR22725 with the U.S. Department of Energy. The United States Government retains and the publisher, by accepting the article for publication, acknowledges that the United States Government retains a non-exclusive, paid-up, irrevocable, worldwide license to publish or reproduce the published form of this manuscript, or allow others to do so, for United States Government purposes. The Department of Energy will provide public access to these results of federally sponsored research in accordance with the DOE Public Access Plan (http://energy.gov/downloads/doe-public-access-plan).}}

\author[1]{Reuben D. Budiardja*}

\author[2]{Timothy Bouvet}

\author[2]{Galen Arnold}

\authormark{Budiardja \textsc{et al}}

\address[1]{\orgdiv{National Center for Computational Sciences}, \orgname{Oak Ridge National Laboratory}, \orgaddress{\state{Oak Ridge, TN 37831}, \country{USA}}}

\address[2]{\orgdiv{National Center for Supercomputing Applications}, \orgname{University of Illinois at Urbana-Champaign}, \orgaddress{\state{IL 61801}, \country{USA}}}

\corres{*Reuben D. Budiardja, Oak Ridge National Laboratory, One Bethel Valley Road, P.O. Box 2008, MS-6008, Oak Ridge, TN 37831-6008 \email{reubendb@ornl.gov}}

\abstract[Summary]{Monitoring and testing for regression of large scale systems such as the NCSA's Blue Waters supercomputer are challenging tasks. 
...
\keywords{System-monitoring; Regression-testing; Applications; Performance; Benchmarking}
...
For this purpose we have chosen to use Jenkins \cite{jenkins}. (For an evaluation of other tools that may be used for this purpose, see \cite{VergaraLarrea}.)
...
\end{figure}
The IOR test is set to run as scheduled by Jenkins with a best-effort through our batch system. Figure \ref{fig:IOR-configuration-sample} shows sample configuration script for this test. 
The test synchronously blocks such that the next test will not start until the previous one has completed.
We employ a watchdog script (see Listing \ref{lst:watchdog} and its output \ref{fig:IOR-watchdog-out}) to monitor the batch queue and keep the test active until the system marks it as finished.
