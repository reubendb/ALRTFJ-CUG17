...
\author{
%\IEEEauthorblockN{Christian Y. Cardall, Eirik Endeve, \& Anthony Mezzacappa}
...
The outline of this paper is as follows. In \S \ref{sec:JenkinsConfiguration} we describe in details how we configure Jenkins for our deployment. In 
